...
const syntaxChecks = [
  ...
  ["typed declarations", "let x: Dec = 1; final y: Bool = true;"],
  ...
  ["function with params and return type", "fun add(x: Dec, y: Dec) -> Dec: return x + y; end"],
  ["function return without value", "fun v() -> Void: return; end"],
  ["record with fields", "record Person { public name: String; private age: Dec; }"],
...
const syntaxErrors = [
  ...
  ["record missing semicolon in field", "record R { public x: Dec }"],
